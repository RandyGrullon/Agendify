...
const schema = z.object({
    ...
    quotedAmount: z.coerce.number().min(0, "El monto no puede ser negativo"),
    deposit: z.coerce.number().min(0, "El abono no puede ser negativo").optional(),
    service: z.string().min(1, "Servicio requerido"),
    status: z.enum(['pending', 'confirmed', 'completed', 'cancelled']),
    myProfit: z.coerce.number().min(0, "La ganancia no puede ser negativa"),
    bank: z.string().optional(),
    collaboratorPayment: z.coerce.number().min(0, "El pago no puede ser negativo"),
...
export default function AgendaForm({ isOpen, onClose, onSubmit, initialData }: AgendaFormProps) {
    ...
    const quotedAmount = watch('quotedAmount');
                            ...
                            <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6">
                                ...
                                <div className="sm:flex sm:items-start">
                                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                                        ...
                                        <div className="mt-4">
                                            <form onSubmit={handleSubmit(handleFormSubmit)} className="grid grid-cols-1 gap-y-5 gap-x-4 sm:grid-cols-2">
                                                        ...
                                                        render={({ field }) => (
                                                            <Combobox
                                                                ...
                                                                onChange={(service) => {
                                                                    ...
                                                                    if (service) {
                                                                        setValue('quotedAmount', service.price);
                                                                        // Calculate profit if needed, e.g. 100% profit if no collaborator
                                                                        setValue('myProfit', service.price); 
                                                                    }
                                                                }}
                                                            >
                                                ...
                                                <div className="sm:col-span-1">
                                                    ...
                                                    <input {...register("quotedAmount")} type="number" min="0" step="0.01" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm border p-2 text-gray-900 placeholder:text-gray-500" placeholder="0.00" />
                                                ...
                                                <div className="sm:col-span-1">
                                                    ...
                                                    <div className="relative">
                                                        <input {...register("deposit")} type="number" min="0" step="0.01" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm border p-2 text-gray-900 placeholder:text-gray-500" placeholder="0.00" />
                                                ...
                                                <div className="sm:col-span-1">
                                                    ...
                                                    <input {...register("myProfit")} type="number" min="0" step="0.01" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm border p-2 text-gray-900 placeholder:text-gray-500" placeholder="0.00" />
                                                ...
                                                <div className="sm:col-span-1">
                                                    ...
                                                    <input {...register("collaboratorPayment")} type="number" min="0" step="0.01" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm border p-2 text-gray-900 placeholder:text-gray-500" placeholder="0.00" />
                                                ...
                                                <div className="sm:col-span-2 mt-4 flex justify-end gap-3">
                                                    <button
                                                        type="button"
                                                        className="inline-flex justify-center rounded-md border border-gray-300 bg-white px-6 py-2 text-base font-medium text-gray-900 shadow-sm hover:bg-gray-50 focus:outline-none sm:text-sm"
                                                        onClick={onClose}
                                                    >
                                                        Cancelar
                                                    </button>
                                                    <button
                                                        type="submit"
                                                        className="inline-flex justify-center rounded-md border border-transparent bg-blue-600 px-6 py-2 text-base font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none sm:text-sm"
                                                    >
