...
const tutorialSteps: TutorialStep[] = [
  {
    ...
    description:
      "Tu asistente personal para gestionar citas, clientes y servicios de manera profesional. Vamos a conocer las funcionalidades principales.",
    icon: <Check className="w-12 h-12 text-blue-600" />,
  },
  {
    title: "Dashboard",
    description:
      "Visualiza todas tus citas en un solo lugar. Cambia entre vista de lista, calendario y kanban según tus preferencias.",
    icon: <BarChart3 className="w-12 h-12 text-blue-600" />,
  },
  {
    title: "Gestión de Citas",
    description:
      "Crea, edita y organiza citas fácilmente. Rastrea pagos, abonos y lo que te queda por cobrar en tiempo real.",
    icon: <Calendar className="w-12 h-12 text-green-600" />,
  },
  {
    title: "Clientes",
    description:
      "Administra tu cartera de clientes con toda su información de contacto y historial de citas en un solo lugar.",
    icon: <Users className="w-12 h-12 text-purple-600" />,
  },
  {
    title: "Exportar e Importar",
    description:
      "Exporta tus datos a Excel para análisis externos. Importa citas masivamente desde archivos Excel.",
    icon: <FileText className="w-12 h-12 text-indigo-600" />,
  },
  {
    title: "Configuración",
    description:
      "Personaliza tu negocio, configura seguridad con PIN o biometría, y ajusta las preferencias de la aplicación.",
