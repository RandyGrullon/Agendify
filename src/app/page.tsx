    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <header className="flex items-center justify-between p-6 lg:px-8">
        ...
        <div className="flex items-center gap-4">
          <Link
            href="/login"
            className="rounded-md px-3.5 py-2.5 text-sm font-semibold text-gray-900 hover:text-blue-600"
          >
            Iniciar Sesión
          </Link>
          <Link
      ...
      <main className="flex-1 flex items-center justify-center px-6">
        <div className="max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Organiza tu agenda, controla tus ganancias y gestiona tus clientes
            en un solo lugar. Diseñado para profesionales que quieren crecer.
          </p>
          <div className="mt-8 flex justify-center gap-4">
            <Link
              href="/register"
              className="inline-flex items-center rounded-md bg-blue-600 px-5 py-3 text-sm font-medium text-white hover:bg-blue-500"
            >
              Comenzar Gratis
            </Link>
            <Link
          ...
          <div className="mx-auto mt-10 grid max-w-xl gap-8 md:grid-cols-3 lg:max-w-none">
            <div className="relative pl-16">
              ...
              <dd className="mt-2 text-base leading-7 text-gray-600">
                Gestiona tus citas con facilidad, evita conflictos y mantén tu
                día organizado.
              </dd>
            </div>
            <div className="relative pl-16">
              ...
              <dd className="mt-2 text-base leading-7 text-gray-600">
                Visualiza tus ganancias, pagos a colaboradores y montos
                cotizados en tiempo real.
              </dd>
            </div>
            <div className="relative pl-16">
              <dt className="text-base font-semibold leading-7 text-gray-900">
              ...
              <dd className="mt-2 text-base leading-7 text-gray-600">
                Mantén un registro detallado de tus clientes y sus servicios
                históricos.
              </dd>
            </div>
          </div>
