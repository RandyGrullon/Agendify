                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2 mt-2 text-gray-500">
                                    <Calendar size={16} />
                                    <span>Cliente desde {format(new Date(client.createdAt), 'MMMM yyyy', { locale: es })}</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="p-6 space-y-6">
                                {client.email && (
                                    <div className="flex items-start gap-4 group">
                                        ...
                                        <div>
                                            ...
                                            <a href={`mailto:${client.email}`} className="text-gray-900 hover:text-blue-600 transition-colors font-medium break-all">
                                                {client.email}
                                            </a>
                                        </div>
                                    </div>
                                ...
                                {client.phone && (
                                    <div className="flex items-start gap-4 group">
                                        ...
                                        <div>
                                            ...
                                            <a href={`tel:${client.phone}`} className="text-gray-900 hover:text-green-600 transition-colors font-medium">
                                                {client.phone}
                                            </a>
                                        </div>
                                    </div>
                                ...
                                {client.notes && (
                                    <div className="pt-4 border-t border-gray-100">
                                        <p className="text-sm font-medium text-gray-500 mb-3">Notas Adicionales</p>
                            ...
                            <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 col-span-2">
                                <div className="flex items-center justify-between mb-3">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-sm font-medium text-gray-500">Inversión Total</span>
                                    </div>
                                </div>
                            ...
                            <div className="p-6">
                                {appointments.length === 0 ? (
                                    <div className="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-200">
                                        ...
                                        <p className="text-sm text-gray-400 mt-1">Las citas aparecerán aquí cuando las crees</p>
                                    </div>
                                ) : (
                                                ...
                                                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 pl-2">
                                                    <div className="flex-1">
                                                        <div className="flex items-center gap-3 mb-2">
                                                            <h3 className="font-bold text-gray-900 text-lg">{appointment.service}</h3>
